<div class="text-start m-2">
	...
	Philipp Foos<br>
	Essinger Straße 52<br>
	76877 Offenbach a.d. Queich<br><br>
	Email: philipp[at]netzhost24[dot]de<br><br>
	Dieses Teamspeak 3 Webinterface nutzt die ts3admin.class von <a href="http://www.ts3admin.info" target="_blank">ts3admin.info</a>.
	<br><br>
	...
	<br>
	<h4>Matomo</h4>
	<p>Diese Website benutzt den Open Source Webanalysedienst Piwik. Piwik verwendet so genannte "Cookies". Das sind Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der Website durch Sie erm&ouml;glichen. Dazu werden die durch den Cookie erzeugten Informationen &uuml;ber die Benutzung dieser Website auf unserem Server gespeichert. Die IPAdresse wird vor der Speicherung anonymisiert.</p>
